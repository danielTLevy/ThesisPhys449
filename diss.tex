...
\title{Simulations of an Aerogel Ring Imaging Cherenkov Detector for Particle Identification}
...
%% files
\hypersetup{
  pdftitle={Daniel Levy Thesis - PHYS 449},
  pdfauthor={Daniel Levy},
  pdfkeywords={Aerogel Ring Imaging Cherenkov Detector EMPHATIC simulation }
}
