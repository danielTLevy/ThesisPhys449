...
In this equation, $\mu$ is the ratio $n_1/n_2$ between the , where $n_1$ is the index of refraction of the aerogel, and $n_2, $\bf{s}$ is the unit direction of the incident photon, $\bf{g}$ is the unit normal vector pointing out of the side of the aerogel slab the photon is exiting, and $\bf{s'}$ is the unit vector direction of the photon after being refracted.
