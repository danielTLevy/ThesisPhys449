...
The majority of EMPHATIC has already been written into a simulation using Geant4, a platform designed for Monte Carlo simulations of particles passing through matter \cite{geant4}.
However, there is a need for an even more efficient and lightweight Monte Carlo simulation that can be run with different parameters for every single experimental event.
